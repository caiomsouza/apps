...
<div id="tabs"   >
	<ul>
		<li><a href="#tabs-1">Painel de Controle dos Empreendimentos</a></li>
		<li><a href="#tabs-2">Cubo OLAP - Obras do PAC</a></li>
		<li><a href="#tabs-3">Sobre</a></li>
		<li><a href="#tabs-4">Videos</a></li>
		<li><a href="#tabs-5">Sobre a IT4biz</a></li>
	...
	<div id="tabs-3">
		...
		<p>Este aplicativo mostra, de diversas maneiras, os investimentos realizados nas Obras do PAC (Programa de Aceleração do Crescimento).

Através de Dashboards e Análises OLAP você poderá cruzar os dados e saber como está sendo investido o nosso dinheiro.</p>
